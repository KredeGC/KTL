...
namespace ktl::test::segragator_allocator
{
    KTL_ADD_TEST(test_segragator_variadic)
    {
        ...
        // This will be the autogenerated allocator, up to 3 comparisons
        ...
        // This would be optimal, at max 2 comparisons
        using Alloc4 = segragator<16,
            segragator<8,
                linear_allocator<1024>,
                linear_allocator<2048>>,
            segragator<32,
