...
namespace ktl
{
	...
	template<typename PtrT, typename IntT, size_t Bits, IntT Min = detail::min_range<IntT>(Bits), IntT Max = detail::max_range<IntT>(Bits), size_t Alignment = alignof(std::remove_pointer_t<PtrT>)>
	class packed_ptr;
}