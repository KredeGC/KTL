...
namespace ktl
{
	...
	//	{
	//		size_t Size;
	//		alignas(T) uint8_t[InlineCapacityInBytes] Buffer;
	//	};

	//	using value_type = std::variant<InlineVec, Vec>;
	...
	//		m_Data(std::in_place_type<InlineVec>, 0) {}

	//	/**
	//	 * @brief Construct the vector with the given allocator
	//	 * @param allocator The allocator to use
	//	*/
	//	explicit small_vector(const Vec& vec) noexcept :
	...
	//	*/
	//	explicit small_vector(size_t n) :
	//		m_Data()
	//	{
	//		// TODO: Initialize vector if too big
	//	}
	...
	//	 * @param allocator The allocator to use. Will be default constructed if unspecified
	//	*/
	//	explicit small_vector(size_t n, const T& value, const allocator_type& allocator = allocator_type()) :
	//		m_Data()
	//	{
	//		
	//	}
	...
	//	 * @param allocator The allocator to use. Will be default constructed if unspecified
	//	*/
	//	small_vector(std::initializer_list<T> initializer, const allocator_type& allocator = allocator_type()) :
	//		m_Data()
	//	{
	//		
	//	}
	...
	//	 * @param allocator The allocator to use. Will be default constructed if unspecified
	//	*/
	//	explicit small_vector(const T* first, const T* last, const allocator_type& allocator = allocator_type()) :
	//		m_Data()
	//	{
	//		
	//	}
	...
	//	small_vector(const small_vector& other, const allocator_type& allocator) noexcept :
	//		m_Data(other.m_Data)
	//	{
	//		
	//	}

	//	small_vector(small_vector&& other, const allocator_type& allocator) noexcept :
	//		m_Data(std::move(other.m_Data))
	//	{
	//		
	//	}
